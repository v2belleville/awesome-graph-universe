...
- [yWorks, yFiles graphs for Jupyter](https://www.yworks.com/products/yfiles-graphs-for-jupyter) ![Purpose](https://img.shields.io/badge/purpose-networkAnalysis-orange) ![Purpose](https://img.shields.io/badge/purpose-localAnalysis-orange) Visualize graphs in Jupyter with extensive interactife features. Building Nodes and relationships from any format. [yWorks github](See https://github.com/yWorks) for specific ![Techno](https://img.shields.io/badge/techno-Neo4j-green) and other versions.
- [neo4j-viz](https://neo4j.com/docs/nvl-python/preview/) ![Purpose](https://img.shields.io/badge/purpose-networkAnalysis-orange) ![Purpose](https://img.shields.io/badge/purpose-localAnalysis-orange) Visualize graphs in Jupyter, from GQL queries, Neo4j db, Panda Dataframe or Nodes and relationship built from any format. Interactive repositionning of nodes and zoom in/out.
